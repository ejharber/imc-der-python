...
mocap_tool_poses[:, :3] = mocap_tool_poses[:, :3] # mocap data is in mm
mocap_base_poses = data["mocap_base_data"]
mocap_base_poses[:, :3] = mocap_base_poses[:, :3]
...
def convert_vec_to_matrix(vec, switch):
...
T_mocap_robot2 = convert_vec_to_matrix(mocap_tool_poses, False)
T_mocap_base2 = convert_vec_to_matrix(mocap_base_poses, False)
T_base1_robot1 = convert_vec_to_matrix(ur5e_tool_poses, False)
