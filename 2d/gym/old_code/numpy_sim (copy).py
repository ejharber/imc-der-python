...
def run_simulation(x0, u0, N, dt, RodLength, deltaL, g, EI, EA, damp, m1, m2, m3, traj_u = np.zeros((3, 1))):
    # Initial DOF vector
    # Initial Position
    q0 = np.array([x0]).T
...
@jit(cache=True)
def _run_simulation(q0, u0, N, dt, RodLength, deltaL, g, EI, EA, damp, m1, m2, traj_u):
